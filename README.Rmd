...
You can install the **stable** version from [CRAN](https://cran.r-project.org/package=dress):
...
- Common questions about dress package are often found on [stack-overflow](https://stackoverflow.com/). 
